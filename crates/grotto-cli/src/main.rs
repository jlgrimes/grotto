...
mod tests {
    ...
    mod daemon_register_tests {
        ...
        /// Serializes tests that read/write the global ~/.grotto/sessions.json registry.
        /// Without this, parallel tests race on the shared file and produce flaky failures.
